...
<body>
    ...
    <div class="OversightTeamContainer">
        <div class="containerTitle">
            <h4>Découvrez l'équipe Oversight</h4>
        </div>
        ...
        <div class="members">
            <div class="first">
                <div class="person">
                    ...
                    <h4 class="ThibaultFunction">Directeur, Logiciel & Web, Back-End</h4>
                </div>

                <div class="person">
                    <img src="../../img/Lucas.png" class="imgLucas"></img>
                    <h4 class="LucasName">Lucas Chevalier</h4>
                    <h4 class="LucasFunction">Directeur, Logiciel & Web, Front-End</h4>
                </div>
